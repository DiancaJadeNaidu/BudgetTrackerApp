...
class SimpleChatbot {
    ...
    private val responses = listOf(
        ...
        Pair(listOf("how to backup", "backup data", "cloud sync"), "Your data is automatically backed up if you’ve enabled cloud sync in Settings."),
      //  Pair(listOf("change currency", "set currency", "wrong currency"), "Go to Settings > Currency to change your default currency."),
      //  Pair(listOf("language", "change language"), "You can change the app language under Settings > Language & Region."),
